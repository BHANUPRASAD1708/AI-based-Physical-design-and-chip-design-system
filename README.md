...
Features
✔ Reinforcement Learning-based chip placement (PPO) ✔ Multi-layer routing (Manhattan + A* routing) ✔ Routing congestion analysis & heatmap ✔ Timing estimation (gate + interconnect delay) ✔ Power modeling ✔ Thermal heatmap generation ✔ 3D chip stacking (TSV-based) ✔ Dataset generator (1000+ chip designs) ✔ 2D & 3D visualization
